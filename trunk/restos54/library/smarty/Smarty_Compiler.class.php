...
/* HS: rajout pour pouvoir faire ->layout()->content */
        $this->_obj_start_regexp = '(?:' . $this->_dvar_regexp . '(?:' . $this->_obj_ext_regexp . '(?:' . $this->_obj_params_regexp . ')?)+)';

        $this->_obj_call_regexp = '(?:' . $this->_obj_start_regexp . '(?:' . $this->_obj_params_regexp . ')?(?:' . $this->_dvar_math_regexp . '(?:' . $this->_num_const_regexp . '|' . $this->_dvar_math_var_regexp . ')*)?)';

/* HS: rajout pour test
        $template_tag = '$this->layout()->content';

        print_r($this->_obj_call_regexp);

        if( preg_match('~^' . $this->_obj_call_regexp . '$~xs', $template_tag, $matches)) {
            print_r($matches);
        }
        else {
            print_r($matches);
...
/* la fameuse regexp de maboule :
        echo '~^(?:(' . $this->_num_const_regexp . '|' . $this->_obj_call_regexp . '|' . $this->_var_regexp
