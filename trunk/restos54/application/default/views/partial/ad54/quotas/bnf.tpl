...
var productColumns =  [
            ...
            {header: "repartition en moyenne", renderer: pourcent, summaryType: 'sum',sortable: true, dataIndex: "repartition"},
            {header: 'moyenne des parts campagne précédente', summaryType: 'sum',dataIndex: 'parts', sortable: true},
