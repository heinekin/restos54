...
<blocs>
    <bloc type="page">
        <content method="innerHTML" id="main"><!--
            <h1>Entrer une nouvelle collecte</h1>
<table id="tableMain">
                <tr>
 ...
 */
    var gridForm = new Ext.FormPanel({
        ...
        buttons: [{
            ...
            text: 'Sauvegarder',
            handler: function(){
                    gridForm.getForm().submit({url:'ad54/stocks/savecollecte', waitMsg:'Sauvegarde de la collecte...', success: function(){store2.reload();}});
}
        ...
        items: [{
            ...
            items: [{
                ...
                xtype: 'numberfield',
                fieldLabel: 'colis collectés',
                name: 'nb_colis',
                allowBlank: false,
                blankText: 'Vous devez renseigner le nombre de colis collecté'
            }]
        }],
